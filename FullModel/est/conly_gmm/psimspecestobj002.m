...
%  psimspecest002.m		- Objective function for estimated speculation model ( corresponds to parameterization in brstheory_eq001.pdf)
...
%  Generate constants
[vd vi ce1 cg1 cd1 ci1 ce2 cg2 cd2 ci2 cb2 bmvar varv]		=	bayes002(parvec,b,xvar);
