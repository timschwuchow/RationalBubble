...
[pol V]		=	vfsolpar002_tx(regrid(repng),cd1grid(repng),ce1grid(repng),bmvargrid(repng),b,H,N,xgrid(repng),vftolcrit,vfmaxiter,cnsprob,imap,emap(repng,:),dmap(repng,:),umap(repng,:),smap,smapinv,howimp,howlag,V,tx);
clear cnsprob
